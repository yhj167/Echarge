...
<table cellspacing='1' cellpadding='3' border="0">
  ...
  <tr>
    ...
    <td >*******</td>
    <td align="right" >自助操作：<br /></td>
    <td >
    	<input type="button" value="修改密码" style="width:160px;" onclick="javascript:window.location.href ='UserModiPwd.jsp';"/>
    </td>
  </tr>
</table>
<table cellspacing='1' cellpadding='3' border="0">
  ...
  <tr>
    ...
    <td align="right" >自助操作：<br /></td>
    <td >
    	<input type="button" value="修改个人信息" style="width:160px;" onclick="javascript:window.location.href ='UserModify.jsp';"/>
    </td>
  </tr>
</table>
<table cellspacing='1' cellpadding='3' border="0">
  ...
  <tr>
    ...
    <td align="right" >自助操作：</td>
    <td >
    	<input type="button" value="客户交费" style="width:160px;" onclick="javascript:window.location.href ='UserJiaofei.jsp';"/>
    </td>
  </tr>
  <tr>
    ...
    <td align="right" >自助操作：</td>
    <td >
    	<input type="button" value="客户退费" style="width:160px;" onclick="javascript:window.location.href ='UserTuifei.jsp';"/>
    </td>
  </tr>
</table>
</div>
