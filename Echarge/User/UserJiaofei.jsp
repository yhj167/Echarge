...
<%
	...
	if (action != null && action.trim().equals("UserJiaofei")) {
 ...
 return true;
	...
	<body>
		<table style="table-layout: fixed;" align="center" border="0" cellpadding="0" cellspacing="0" width="97%">
			<tbody>
				...
				<td class="nav" align="left" nowrap="nowrap" width="100%">
					<h1>
			<span class="action-span"></span><span>Echarge 管理中心 - 客户交费</span>
					</h1>
				</td>
				</tr>
			</tbody>
		...
		<div class="fill_message">
			<form name="form1" method="post" action="UserJiaofei.jsp" id="f">
			<input type="hidden" name="action" value="UserJiaofei" />
