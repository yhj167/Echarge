...
--></style>
	...
	<body leftmargin="0" rightmargin="0" topmargin="0" onkeydown="if(event.keyCode==27) return false;">
		...
		<table style="table-layout: fixed;" align="center" border="0"
			...
			<tbody>
				...
				<td class="nav" align="left" nowrap="nowrap" width="100%">
					<h1>
				<span class="action-span"></span><span>Echarge 管理中心  - 客户列表 </span>
				</h1>
				</td>
		...
		<center><a href="UserRegister.jsp">添加新客户</a></center>
		...
		<form action="UserListDeleteServlet" name="form1" method="post">
	    ...
	    <table class="tableborder" align="center" cellpadding="4"
          ...
          <tr class="header">
            ...
            <td align="center" width="9%"> 身份证号 </td>
		...
		<tr>
            ...
            <td class="altbg1" align="center">
            	<%=new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(u.getRDate())%> 
			</td>
            ...
            %>
              ...
              <!-- 
              <a href="UserInfo.jsp?clientAccount=<%=u.getClientAccount()%>">详细</a>
