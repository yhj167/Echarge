...
public final class DB_005fBackup_jsp extends org.apache.jasper.runtime.HttpJspBase
...
/*
	...
	if (request.getParameter("backupTime") != null) {
      ...
      out.write("\t\t<meta name=\"description\" content=\"Echarge数据库备份\"/>\r\n");
      ...
      out.write("\t\tvar ids = document.getElementsByName(\"id\");\r\n");
      out.write("\t\tvar j = 0;\r\n");
      out.write("\t\tif (document.form1.path.value == \"\") {\r\n");
      out.write("\t\t\talert(\"请点击浏览按钮选择导出路径！\");\r\n");
      out.write("\t\t\twindow.location.href= \"DB_Backup.jsp\";\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\tfor ( var i = 0; i < ids.length; i++) {\r\n");
      ...
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif (j == ids.length) {\r\n");
      out.write("\t\t\t\talert(\"请选择要导出的数据库表！\");\r\n");
      out.write("\t\t\t\twindow.location.href= \"DB_Backup.jsp\";\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      ...
      out.write(" \t\tvar Folder = Shell.BrowseForFolder(0,Message,0); //起始目录为：桌面\r\n");
      ...
      out.write("\t\t\t\t\t\t<h1>\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"action-span\"></span><span>Echarge 管理中心 - 数据库备份</span>\r\n");
      out.write("\t\t\t\t\t\t</h1>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</tbody>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t\t<br>\r\n");
      out.write("\t\t<form name=\"form1\" method=\"post\" action=\"DBbackup\" id=\"f\">\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"action\" value=\"DB_Backup\" />\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"path\" type=\"text\" class=\"text_input\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 200px;\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"button\" value=\"浏览\" style=\"width: 80px;\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"browseFolder(path);\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"submit\" value=\"开始导出\" onclick=\"return confirm('开始导出?')\" style=\"width: 80px;\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td height=\"3\"></td>\r\n");
...
String url = request.getRequestURL()
      ...
      out.write("\t\t\t\t\t\t\t<input name=\"selectAll\" type=\"checkbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\tonclick=\"return checkDelete()\" />\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"3\" class=\"altbg1\">\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</tbody>\r\n");
