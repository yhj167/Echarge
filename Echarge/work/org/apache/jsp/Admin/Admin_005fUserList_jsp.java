...
if(action != null && action.trim().equals("Delete")) {
	...
	if (pageNo > totalPages)
      ...
      out.write("\t\t<meta name=\"description\" content=\"Echarge用户列表\">\r\n");
      ...
      out.write("\t\t\t\t\t<h1>\r\n");
      out.write("\t\t\t\t<span class=\"action-span\"></span><span>Echarge 管理中心  - 用户列表 </span>\r\n");
      out.write("\t\t\t\t</h1>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t<br>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<center><a href=\"Admin_AddUser.jsp\">添加新用户</a></center>\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t</table>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<form action=\"AdminDeleteServlet\" name=\"form1\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t<td class=\"altbg1\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(a.getPhoneNum());
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"altbg1\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(a.getAdminEmail());
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"altbg1\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(a.getAdminAddress());
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"altbg1\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(a.getAddDate()));
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"altbg1\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t");
 String url = request.getRequestURL() + (request.getQueryString() == null ? "" : "?" + request.getQueryString()); 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<a href=\"Admin_DeleteResult.jsp?loginName=");
      out.print(a.getLoginName());
      out.write("&from=");
      out.print(url);
      out.write("\" onclick=\"return confirm('真的要删除?')\">删</a>\r\n");
      out.write("\t\t\t\t\t\t<a href=\"Admin_UserInfo.jsp?loginName=");
      out.print(a.getLoginName());
      out.write("\">详细</a>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
