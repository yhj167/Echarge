...
public final class ChargingList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	int totalRecords = ChargingMgr.getInstance().getChargings(chargings, pageNo, PAGE_SIZE);
	...
	if (pageNo > totalPages)
      ...
      out.write("\t<title>客户充电表</title>\r\n");
      out.write("\t<meta http-equiv=\"Content-Type\" content=\"text/html; charset=gb2312\" />\r\n");
      out.write("\t<meta name=\"keywords\"\r\n");
      out.write("\t\t\tcontent=\"Discuz!,Board,Comsenz,forums,bulletin board,\">\r\n");
      out.write("\t\t<meta name=\"description\" content=\"Echarge客户充电表\">\r\n");
      ...
      out.write("\t\t} else if (f == 3) {\r\n");
      out.write("\t\t\tlay3.style.display = \"inline\"\r\n");
      out.write("\t\t\tlay4.style.display = \"none\"\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\tlay3.style.display = \"none\"\r\n");
      out.write("\t\t\tlay4.style.display = \"inline\"\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t}\r\n");
      out.write("\t</script>\r\n");
      out.write("\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("function Hidden(t1,t2,t3,t4,t5){\r\n");
      out.write("\tvar t1,t2,t3,t4,t5;//表格ID\r\n");
      ...
      out.write("\tt5.style.display=\"none\";\r\n");
      out.write("\twindow.print(); \r\n");
      out.write("\tt1.style.display=\"\";//切换为显示状态\r\n");
      out.write("\tt2.style.display=\"\";\r\n");
      out.write("\tt3.style.display=\"\";\r\n");
      out.write("\tt4.style.display=\"\";\r\n");
      out.write("\tt5.style.display=\"\";\r\n");
      out.write("\treturn;\r\n");
      out.write("}\r\n");
      out.write("</script>\t\r\n");
      out.write("\t\r\n");
      ...
      out.write("\tdocument.execCommand(\"saveAs\",\"true\",\"ChargingList.xls\");\t\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t\t<table id=\"t1\" style=\"table-layout: fixed;\" align=\"center\" border=\"0\"\r\n");
      out.write("\t\t\tcellpadding=\"0\" cellspacing=\"0\" width=\"97%\">\r\n");
      out.write("\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td class=\"nav\" align=\"left\" nowrap=\"nowrap\" width=\"100%\">\r\n");
      out.write("\t\t\t\t\t<h1>\r\n");
      out.write("\t\t\t\t<span class=\"action-span\"></span><span>Echarge 管理中心  - 客户充电表 </span>\r\n");
      out.write("\t\t\t\t</h1>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t<form method=\"post\" name=\"form1\" action=\"ChargingSearchResult.jsp\">\r\n");
      ...
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td width=\"35%\" align=\"left\" nowrap=\"nowrap\">\r\n");
      out.write("\t\t\t\t<input id=5 type=radio name=r2 value=5 checked onclick=mm(3)><label for=\"5\">所有充电桩</label>\r\n");
      out.write("\t\t\t\t<span id=lay3 style=\"display:inline\"></span>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\t<input id=6 type=radio name=r2 value=6 onclick=mm(4)><label for=\"6\">指定充电桩</label>\r\n");
      out.write("\t\t\t\t<span id=lay4 style=\"display:none\"><input type=\"text\" name=\"machineNo\" value=\"请输入充电桩号\"></span>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<td align=\"left\" nowrap=\"nowrap\" width=\"35%\">\t\r\n");
      ...
      out.write("\t\t</tr>\r\n");
      out.write("\t</table>\r\n");
      out.write("\t<table id=\"t3\" style=\"border-bottom:dotted #999999 1px;\" align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"97%\">\r\n");
      out.write("\t\t<tr>\t\r\n");
      out.write("\t\t\t<td align=\"left\" nowrap=\"nowrap\" width=\"35%\"><span class=\"nav\">\t\t\t\t\t\r\n");
      out.write("\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"outertxt\">\r\n");
      out.write("\t\t\t\t<label for=\"3\">开始日期</label>\r\n");
      out.write("\t\t\t\t<input id=3 readonly type=\"text\" name=\"dateFirst\"\r\n");
      out.write("\t\t\t\tonclick=\"getDateString(this,oCalendarChs)\" value=\"2000-01-01\" size=\"20\">\r\n");
      out.write("\t\t\t</span><span class=\"nav\">\t\t\t    </span></td>\r\n");
      out.write("\t\t\t<td align=\"left\" nowrap=\"nowrap\"><span class=\"nav\">\t\t\t\t\r\n");
      out.write("\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"outertxt\">&nbsp;\r\n");
      out.write("\t\t\t\t<label for=\"4\">结束日期</label>\r\n");
      out.write("\t\t\t\t<input id=4 readonly type=\"text\" name=\"dateLast\"\r\n");
      out.write("\t\t\t\tonclick=\"getDateString(this,oCalendarChs)\" value=\"2050-12-31\" size=\"20\">\r\n");
      out.write("\t\t\t</span><span class=\"nav\">\t\t\t    </span></td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t</table><br>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<table id=\"t4\" align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"97%\">\r\n");
      out.write("\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td>&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"ChargingList.jsp?pageNo=");
      out.print(i);
      out.write('"');
      out.write('>');
      out.print(i);
      ...
      out.write("\t\t\t\t\t\t");
      out.print(c.getClientAccount());
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<td class=\"altbg1\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(c.getMachineNo());
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"altbg1\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(c.getElecQuantity());
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"altbg1\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t<td class=\"altbg1\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(c.getTheBalance());
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"altbg1\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(c.getChargingMode());
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<td class=\"altbg1\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(c.getChargingTime());
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"altbg1\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm").format(c.getStartTime()));
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"altbg1\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm").format(c.getEndTime()));
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<td class=\"altbg1\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t<div id=\"redlink\"><a href=\"ChargeDetailInfo.jsp?ccID=");
      out.print(c.getcID());
      out.write("\">详细</a></div>\r\n");
      out.write("\t\t\t\t\t</td>\t\t\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t<table id=\"t5\" style=\"table-layout: fixed;\" align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"97%\">\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td class=\"nav\" align=\"center\" nowrap=\"nowrap\" width=\"100%\">\r\n");
      out.write("\t\t\t\t\t<input type=\"button\" value=\"打印\" onclick=\"return Hidden(t1,t2,t3,t4,t5)\"/>&nbsp;\r\n");
