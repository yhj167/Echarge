...
<html>
	...
	<meta name="keywords"
		...
		<meta name="description" content="Echarge菜单列表">
...
--></style>
		...
		<script type="text/javascript">
			function checkDelete() {
				var ids = document.getElementsByName("menuId");
		...
		<script type="text/javascript">
			...
			function changeToInput(id) {
				...
				var value = oNP.value;
				oNP.outerHTML = "<input type='text' id='" + menuId + "' value='" + value + "' size='5' onblur='change(this.menuId)'>";
		...
		<table style="table-layout: fixed;" align="center" border="0"
			...
			<tbody>
				...
				<td class="nav" align="left" nowrap="nowrap" width="100%">
					<h1>
				<span class="action-span"></span><span>Echarge 管理中心  - 菜单列表 </span>
				</h1>
				</td>
													...
													for(int i=start; i<start+PAGES_PER_TIME; i++) {
													 ...
													 %>
														...
														<%
														 ...
														 %>
															<td>&nbsp;
																<a href="Admin_MenuList.jsp?pageNo=<%=i%>"><%=i%></a>&nbsp;
															</td>
													<%
														}
													}
													 %>
															<td>&nbsp;
																<a href="Admin_MenuList.jsp?pageNo=<%=pageNo+1%>">&gt;</a>&nbsp;
															</td>
