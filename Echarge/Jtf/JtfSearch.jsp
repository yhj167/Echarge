...
<%
	...
	if (action != null && action.trim().equals("JtfSearch")) {
		...
		session.setAttribute("Jtf", j);
		response.sendRedirect("JtfInfo.jsp");
	}
%>
...
<body>
		...
		<div class="fill_message">
			<form name="form1" method="post" action="JtfSearch.jsp" id="f">
